...
class GarminStatsService(BaseGarminService):
    ...
    async def get_sleep_quality_stats(self, end_date: str = None, days: int = 7) -> List[DailySleep]:
        """
        수면 품질 통계 조회
    ...
    async def get_daily_stress_stats(self, end_date: str = None, days: int = 7) -> List[DailyStress]:
        """
        일간 스트레스 통계
    ...
    async def get_weekly_stress_stats(self, end_date: str = None, weeks: int = 4) -> List[WeeklyStress]:
        """
        주간 스트레스 통계
    ...
    async def get_daily_hrv_stats(self, end_date: str = None, days: int = 7) -> List[DailyHRV]:
        """
        일간 수면 중 HRV 통계
    ...
    async def get_daily_steps_stats(self, end_date: str = None, days: int = 7) -> List[DailySteps]:
        """
        일간 걸음 수 통계
